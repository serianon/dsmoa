...
/**
 * Copycat of the original WithDbScan with some Logs for better understanding
 * or even some changes in code for testing. For testing purposes only.
 */
public class MyWithDbScan extends AbstractClusterer {
...
//						/ (double) horizonOption.getValue();
    ...
    public Clustering getClusteringResult() {
        MyDbScan dbscan = new MyDbScan(p_micro_cluster,/*offlineOption.getValue() **/ epsilon, minPoints);
